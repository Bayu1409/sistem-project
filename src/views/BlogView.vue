    ...
    <main class="w-full h-full overflow-x-hidden">
      ...
      >
        <div class="flex flex-col gap-5">
          ...
          <a
          href="blog/post"
          class="w-[204px] flex items-center justify-center bg-x-blue px-4 py-2 text-white font-bold hover:bg-x-yellow transition duration-150 ease-in-out rounded-lg"
        >
          Read More >
        </a>
        </div>
...
<section class="flex flex-col gap-8 bg-white px-[80px] py-[40px]">
  <h2 class="text-x-black text-4xl font-bold leading-[48px] tracking-[-2px]">
    All Category
  </h2>
  <div class="flex items-center justify-between gap-6">
    ...
    <div class="w-[296px] h-[228px] flex flex-col gap-4 border border-x-mediumgrey bg-opacity-30 p-6 hover:bg-x-blue hover:border-x-blue hover:cursor-pointer transition duration-200 ease-in-out group">
      <div class="w-[48px] h-[48px] bg-x-lightyellow rounded flex items-center justify-center">
